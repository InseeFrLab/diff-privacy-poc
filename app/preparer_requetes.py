...
def bloc_ajout_requete():
    return ui.panel_well(
        ...
        ui.row(
            ...
            ui.column(
                3,
                ui.input_selectize("group_by", "Regrouper par:", choices={}, multiple=True)
            ),
            ui.column(
                3,
                ui.input_text("filtre", "Condition de filtrage:")
            )
        ),
        ui.br(),
        ...
        ui.row(
            ui.column(
                ...
                ui.input_selectize(
                    "affichage_req",
                    "Requêtes à afficher:",
                    choices=["TOUTES", "Comptage", "Total", "Moyenne", "Ratio", "Quantile"],
                    selected="TOUTES",
                    options={"allowEmptyOption": False}
                ),
            )
